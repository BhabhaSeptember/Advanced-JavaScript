...
function checkout() {
    alert("Your order total is: R " + totalOrderAmt);
};
...
function display_all() {
  ...
  myTable +=
    "<th style='width: 100px; color: red; text-align: right;'>Price (R)</th>";
  myTable +=
  ...
  myTable += "</table>"; //table ends here
  
  myTable += "<br/><br/><p>Total: R" + totalOrderAmt + "</p>";
